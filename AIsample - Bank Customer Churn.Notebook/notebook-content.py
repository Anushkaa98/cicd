...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "fe92644a-68da-44c4-9df9-e73a1affa73c",
# META       "default_lakehouse_name": "BankChurn",
# META       "default_lakehouse_workspace_id": "f58f4c0c-536a-4900-9aa2-2bb847ec3f6d",
# META       "known_lakehouses": [
# META         {
# META           "id": "fe92644a-68da-44c4-9df9-e73a1affa73c"
# META         }
# META       ]
# META     },
# META     "warehouse": {
# META       "default_warehouse": "6b531064-691a-4a2e-a5bd-a6e603290951",
# META       "known_warehouses": [
# META         {
# META           "id": "6b531064-691a-4a2e-a5bd-a6e603290951",
...
# #### Since the output from predictions is object type we first convert that into int and log the model version -- need to update it everytime we run the code
...
model = mlflow.pyfunc.load_model("models:/lgbm_sm/1")
...
# Always end any active run first
mlflow.end_run()
...
model = MLFlowTransformer(
    ...
    modelName="lgbm_sm",
    modelVersion=6   # ← Use the NEW version you just logged
)
